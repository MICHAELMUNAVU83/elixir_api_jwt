...
config :elixir_api_jwt, ElixirApiJwtWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: ElixirApiJwtWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: ElixirApiJwt.PubSub,
  live_view: [signing_salt: "K/zkx1dv"]
...
config :elixir_api_jwt, ElixirApiJwt.Guardian,
  ...
  secret_key: "Gl87u8aM3kv/yM6M1KO7OEfA2DXOaQQ5AvhsUDlS0YSTSmiw9xORsm3YHV5td8r9"
